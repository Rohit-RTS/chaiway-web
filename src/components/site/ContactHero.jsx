...
export function ContactHero() {
  return (
    <section className="relative min-h-[72vh] flex items-center pt-24 pb-16 sm:pt-28 sm:pb-20 overflow-hidden text-center">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 w-full flex flex-col items-center">
        ...
        >
          <Phone className="h-3.5 w-3.5 text-chai-gold" />
          Get in Touch
        </motion.span>
        ...
        >
          Let's Start Your{" "}
          <span className="text-gradient-orange-shimmer inline-block">Chai Journey</span>
        </motion.h1>
        ...
        >
          Franchise enquiries, location queries, or partnership discussions — our team responds within 24 hours. Fill in the form or reach us directly.
        </motion.p>
        ...
        >
          <a
            href={buildWhatsAppLink("Hi! I'd like to know more about Chaiway franchise.")}
            target="_blank"
            rel="noreferrer"
          ...
          >
            <Phone className="h-4 w-4 text-chai-orange" /> Call Us
          </a>
        </motion.div>
      </div>
    </section>
