...
function CountUp({ value, suffix }) {
  ...
  return (
    <span className="font-display text-4xl sm:text-5xl lg:text-5xl font-extrabold text-gradient-orange tabular-nums leading-none inline-flex items-baseline shrink-0">
