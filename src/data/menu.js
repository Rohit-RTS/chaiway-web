const menuCategories = [
  { id: "tea", name: "Tea", tagline: "Kullad, Masala, Tandoor & more", items: [
    ...
    { name: "Neelgiri Chai with Kullad", price: "25" },
    { name: "Special Tandoor Chai", price: "40" }
  ] },
  { id: "milk", name: "Milk", items: [
    { name: "Milk", price: "15" },
    { name: "Masala Milk", price: "20" },
    { name: "Kullad Milk", price: "20" },
    { name: "Haldi Wala Milk", price: "25" }
  ] },
  ...
  { id: "cold-coffee", name: "Cold Coffee & Shakes", items: [
  ...
  { id: "lassi", name: "Lassi", items: [
    { name: "Lassi", price: "39" },
    { name: "Lassi with Ice-Cream", price: "49" },
    { name: "Kulfi", price: "25" }
  ] },
  { id: "pizza", name: "Pizza", tagline: "6 inch & 8 inch", items: [
  ...
  { id: "bites", name: "Chaiway Bites", items: [
  ...
  { id: "fast-bites", name: "Fast Bites", items: [
    { name: "Cream Roll", price: "10" },
    { name: "Toast", price: "10" },
    { name: "Biscuits", price: "10" }
  ] },
  { id: "extras", name: "Water & Extras", items: [
